 ...
 */
package org.casualintellect.ide.contentassist.antlr;
...
import org.casualintellect.ide.contentassist.antlr.internal.InternalCasualIntellectParser;
...
public class CasualIntellectParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalCasualIntellectParser createParser() {
		InternalCasualIntellectParser result = new InternalCasualIntellectParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelAccess().getList_of_statesAssignment(), "rule__Model__List_of_statesAssignment");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalCasualIntellectParser typedParser = (InternalCasualIntellectParser) parser;
